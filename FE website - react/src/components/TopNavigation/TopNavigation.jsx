...
import whiteLogo from '../../asset/image/logowhite.PNG';
import blackLogo from '../../asset/image/logoblack.PNG';
...
class TopNavigation extends Component {
  ...
  <Navbar.Brand className={this.state.navBarTitle} ><NavLink to="/"> <img src={this.state.navBarLogo} alt="" /> </NavLink> </Navbar.Brand>
