...
class Footer extends Component {
     ...
     constructor(){
      ...
      componentDidMount(){
          RestClient.GetRequest(AppUrl.FooterData).then(result=>{
               ...
               facebook:result[0]['facebook'], youtube:result[0]['youtube'], twitter:result[0]['twitter'], footer_credit:result[0]['footer_credit']
     ...
     <h2 className="footerName text-center">Follow Us </h2>
          ...
          <a className="facebook social" href={this.state.facebook} target="_blank" rel='noreferrer'>
