            ...
            <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Employee Attendance Database</h4>
                                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                                    <a href="{{route('add.employee_attendance')}}"><button type="button" class="btn btn-secondary">New Attendance</button></a>
                                </div>
                            </div>
                            <div class="card-body">
...
<td>
<div class="d-flex">
<a href="{{route('edit.employee_attendance',$value->date)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
<a href="{{route('details.employee_attendance',$value->date)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-eye"></i></a>
</div>												
</td>												
</tr>
@endforeach
