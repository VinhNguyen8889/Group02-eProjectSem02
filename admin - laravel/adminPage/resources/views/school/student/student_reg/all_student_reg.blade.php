            ...
            <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Student Registration Database</h4>
                                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <a href="{{route('add.student_reg')}}"><button type="button" class="btn btn-secondary">New Registration</button></a>
                    </div>
                            </div>
                            <div class="card-body">
...
<th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" >ID No</th>
<th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" >Roll</th>
