...
<div class="content-body" style="min-height: 884px;">
			<div class="container-fluid">
                ...
                <div class="card">
                            ...
                            <a href="{{route('all.shift')}}"><button type="button" class="btn btn-secondary">Go Back</button></a>
                    </div>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="{{route('update.shift',$data->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label class="info-title">Shift</label>
