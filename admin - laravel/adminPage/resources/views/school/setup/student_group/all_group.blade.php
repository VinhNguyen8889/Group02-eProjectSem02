            ...
            <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Group Database</h4>
                                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <a href="{{route('add.group')}}"><button type="button" class="btn btn-secondary">Add Group</button></a>
                    </div>
                            </div>
                            <div class="card-body">
...
<a href="{{route('delete.group',$group->id)}}" class="btn btn-danger shadow btn-xs sharp" id="delete"><i class="fa fa-trash"></i></a>
</div>												
</td>												
</tr>
@endforeach
