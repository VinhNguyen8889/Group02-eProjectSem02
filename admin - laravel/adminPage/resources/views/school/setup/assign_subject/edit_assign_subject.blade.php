                ...
                <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="{{route('update.assign_subject',$editData['0']->class_id)}}">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label class="info-title"> Subject </label>
                                                ...
                                                @foreach($school_subjects as $subject)
                                                     <option value="{{ $subject->id }}" {{$data->school_subject_id == $subject->id? 'selected':''}}>{{ $subject->name }}</option>
                                                @endforeach	 
                                               </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" name="assignment_mark[]" class="form-control" value="{{$data->assignment_mark}}">
                                        </div>
                                        </div>

                                        <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="info-title">Objective</label>
                                            <input type="number" min="0" name="objective_mark[]" class="form-control" value="{{$data->objective_mark}}">
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" name="attendance_mark[]" class="form-control" value="{{$data->attendance_mark}}">
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                        <input type="submit" class="btn btn-success" value ="Update Assign Subject">
                                        </div>
