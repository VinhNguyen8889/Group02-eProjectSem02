            ...
            <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Assign Subject Database</h4>
                                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <a href="{{route('add.assign_subject')}}"><button type="button" class="btn btn-secondary">Add Assign Subject</button></a>
                    </div>
                            </div>
                            <div class="card-body">
...
<td>
<div class="d-flex">
<a href="{{route('edit.assign_subject',$assign_subject->class_id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
<a href="{{route('delete.assign_subject',$assign_subject->class_id)}}" class="btn btn-danger shadow btn-xs sharp mr-1" id="delete"><i class="fa fa-trash"></i></a>
<a href="{{route('detail.assign_subject',$assign_subject->class_id)}}" class="btn btn-facebook shadow btn-xs sharp" id="detail"><i class="fa fa-book"></i></a>
</div>												
</td>												
</tr>
@endforeach
