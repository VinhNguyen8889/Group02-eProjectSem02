            ...
            <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Fee Amount Database</h4>
                                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <a href="{{route('add.fee_amount')}}"><button type="button" class="btn btn-secondary">Add Fee Amount</button></a>
                    </div>
                            </div>
                            <div class="card-body">
...
<td>
<div class="d-flex">
<a href="{{route('edit.fee_amount',$fee_amount->fee_category_id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
<a href="{{route('delete.fee_amount',$fee_amount->fee_category_id)}}" class="btn btn-danger shadow btn-xs sharp" id="delete"><i class="fa fa-trash"></i></a>
</div>												
</td>												
</tr>
@endforeach
