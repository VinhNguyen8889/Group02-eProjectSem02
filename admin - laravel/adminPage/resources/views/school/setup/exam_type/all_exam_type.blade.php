            ...
            <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Exam Type Datatable</h4>
                                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <a href="{{route('add.exam_type')}}"><button type="button" class="btn btn-secondary">Add Exam Type</button></a>
                    </div>
                            </div>
                            <div class="card-body">
...
<td>
<div class="d-flex">
<a href="{{route('edit.exam_type',$examType->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
<a href="{{route('delete.exam_type',$examType->id)}}" class="btn btn-danger shadow btn-xs sharp" id="delete"><i class="fa fa-trash"></i></a>
</div>												
</td>												
</tr>
@endforeach
