                                ...
                                <div class="basic-form">
                                    <form method="post" action="{{route('update.review',$result->id)}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="client_name" class="form-control input-default " value="{{$result->client_name}}">
                                            @error('client_name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="client_description" id="summernote1">{{$result->client_description}}</textarea>
                                        ...
                                        @error('client_img')
                                            ...
                                            @enderror
                                        <div class="form-group">
                                        <img id="showImage" src="{{url($result->client_img)}}" class="img-fluid rounded-circle" alt="" style="width:100px;height:100px">
                                        </div>
