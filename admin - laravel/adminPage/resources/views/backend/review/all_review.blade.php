                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <a href="{{route('add.review')}}"><button type="button" class="btn btn-secondary">Add Review</button></a>
                    </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
											...
											<tr>
                                                ...
                                                <td><img src="{{url($item->client_img)}}" style="width:70px; height:40px" alt=""></td>
                                                <td>
													<div class="d-flex">
														<a href="{{route('edit.review',$item->id)}}" class="btn btn-info shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
